...
class ImagenesController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('create', 'update', 'guardarevento', 'getorigen'),
                'users' => array('@'),
            ),
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
                'actions' => array('admin', 'delete', 'guardarevento', 'getorigen'),
                'users' => array('admin'),
            ),
    ...
    function actiongetorigen() {
         $cadena = "";
        $id =0;
        $id = $_POST['tipo'];
        if($id==1){
        $consulta = Imagenes::model()->getAgenciaViaje();    
        }
        
        if($id==3){
        $consulta = Imagenes::model()->getLugarTuristico();          
        }
        
        if($id==2){
        $consulta = Imagenes::model()->getEmpresa();    
        }
